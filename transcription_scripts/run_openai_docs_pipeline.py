...
from transcription_scripts.openai_pdf_pipeline import TRANSCRIPTION_PROMPT, postprocess_pairs, transcribe_pairs


def main() -> None:
    parser = argparse.ArgumentParser(description="End-to-end OpenAI PDF transcription + postprocess pipeline.")
